...
A linguagem simplificada deve, obrigatoriamente, possuir as seguintes estruturas:

\begin{itemize}
	\item Comandos de leitura e escrita
	\item Comando condicional
	\item Comando de repetição
	\item Tratamento de expressões aritméticas
	\item Chamada a subrotinas
\end{itemize}
...
\cite[Apêndice B.1]{Cormen:2009:IAT:1614191}
...
Neste artigo, e em outros que detalhem a implementação da linguagem e do tradutor, a linguagem
